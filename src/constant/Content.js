    ...
    skills_content: [
      {
        ...
        logo: mobileDev,
        skill: ["Java", "Kotlin", "Android Studio", "Swing", "Swift", "Xcode", "JavaScript", "React Native", "NodeJS", "ExpressJS", "Dart", "Flutter", "API's" , "Firebase", "MySQL", "SQL", "MongoDB", "PostgreSQL", "Git/GitHub", "GitLab"],
      },
      {
