  ...
  skills: {
    ...
    skills_content: [
      ...
      },
      {
        ...
        logo: webDev,
        skill: ["Python", "DJango", "Flask", "PHP", "JavaScript", "ReactJS", "jQuery", "Tailwindcss", "ViteJS", "NextJS", "NodeJS", "ExpressJS", "WebSocket", "MySQL", "SQL", "MongoDB", "PostgreSQL", "Git/GitHub", "GitLab"],
      },
      {
